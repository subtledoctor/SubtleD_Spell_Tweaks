...
<div class="section">
  ...
  <h4 class="subheader">Component 2305: Tweak Haste and Slow (SR-only, EE-only)</h4>
  <div class="section">
    <p>Instead of the last one cast being applied, Haste and Slow effects will now fully cancel each other out, resulting in a net neutral effect if you are affected by both, in any order.</p>
  </div>
